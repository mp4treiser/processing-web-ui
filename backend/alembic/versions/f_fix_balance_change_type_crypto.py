"""fix_balance_change_type_crypto

Revision ID: f_fix_balance_change_type_crypto
Revises: 492e18ae5e30
...
revision = 'f_fix_balance_change_type_crypto'
down_revision = '492e18ae5e30'
branch_labels = None
depends_on = None


def upgrade() -> None:
    # Fix the balancechangetype enum to use lowercase values for crypto accounts
